...
const Items = [
  ...
  },
  {
    ...
    title: "Driver Flux",
    description:
      'The website is about lending cars and motorcycles in Malaysia. The basic idea behind the website was "No need to buy a car when you can subscribe it". I have started working on this project in 2018. The client came with this basic idea, and I have made it into reality. The designs were provided by the client, and I did the rest from database design, development, and deployment to AWS. We used Node, Next and mongodb as a tech stack and integrated third party services like Stripe for payment and Mailjet for mail integration. I have developed the MVP in 6 months and now People in Malaysia are actively using these services.',
    category: "lending",
  ...
  },
  {
    ...
    title: "Lyft",
    description:
      "The website is about booking car for personal or business purpose. Any people can book a suitable car and any drivers also apply for any cars through this web application. The company just offers cars. Then, drivers and riders are free people. We used Node, React, Next.js and MongoDB as a tech stack and integrated third party services like Stripe for payment and Mailjet for mail integration.",
    category: "lending",
  ...
  },
  {
    ...
    title: "MGM Resorts",
    description:
      "MGM Resorts International is an gaming and entertainment company with national and international locations featuring best-in-class hotels and casinos, state-of-the-art meetings and conference spaces, incredible live and theatrical entertainment experiences, and an extensive array of restaurant, nightlife and retail offerings. I developed Casino feature for 8 months using several tech stacks and third party integrations.",
    category: "booking",
  ...
  },
  {
    ...
    title: "Jude",
    description:
      "Jude is a healthcare company here to smash bladder taboos, open up conversations about incontinence and help you get on with life, leak-free. I have developed the MVP in 5 months and now People in London are actively using these services.",
    category: "healthcare",
    liveLink: "https://www.wearejude.com/",
  },
  {
